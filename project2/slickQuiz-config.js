...
var quizJSON = {
    "info": {
        "name":    "Quiz / State Capitals",
        "main":    "<p>Let's test your knowledge on state capitals!</p>",
        "results": "<h5>Learn More</h5><p>Feel free to retake the quiz to test your knowledge!</p>",
        "level1":  "You got all the answers correct!",
        "level2":  "Keep studying",
        "level3":  "Keep studying",
        "level4":  "Keep studying",
        "level5":  "Keep studying" // no comma here
    },
    "questions": [
        { // Question 1 - Multiple Choice, Single True Answer
            "q": "Juneau is the capital of which state?",
            "a": [
                {"option": "Colorado",      "correct": false},
                {"option": "New Hampshire",     "correct": false},
                {"option": "Alaska",      "correct": true},
                {"option": "Oregon",     "correct": false} // no comma here
            ],
            "correct": "<p><span>That's right!</span> Juneau is the capital of Alaska! </p>",
            "incorrect": "<p><span>Uhh no.</span> Try again later.</p>" // no comma here
        },
